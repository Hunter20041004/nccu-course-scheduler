...
test('points the live-demo copy at the deployable Sites project', () => {
  ...
  assert.equal(hosting.project_id, 'appgprj_6a556549efe081918038e175841e62e5');
  assert.match(html, /https:\/\/nccu-internship-scheduler\.abuzz-teal-2691\.chatgpt\.site/);
  assert.match(app, /https:\/\/nccu-internship-scheduler\.abuzz-teal-2691\.chatgpt\.site/);
});
