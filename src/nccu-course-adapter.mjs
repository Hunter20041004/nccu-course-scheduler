...
const VERIFIED_SCHEDULE_CORRECTIONS = Object.freeze({
  ...
  '070424001': Object.freeze({
    ...
    events: Object.freeze([
      Object.freeze({ label: '實體期末考，時間待確認', date: '2026-12-23' }),
    ]),
  ...
  '070422001': Object.freeze({
    ...
    events: Object.freeze([
      Object.freeze({ label: '實體期中考，時間待確認', date: '2026-11-02' }),
      Object.freeze({ label: '實體期末考，時間待確認', date: '2026-12-21' }),
    ]),
  ...
  '070425001': Object.freeze({
    ...
    events: Object.freeze([
      Object.freeze({ label: '考試日期官方資料不一致（10/28、12/16 或 12/23），待官方確認' }),
    ]),
    informationNotes: Object.freeze(['週二 13:20–15:10 optional recitation']),
    deliveryNote: '官方 115-1 課綱：可接受非同步授課；同步遠距為週三 09:10–12:10。',
  }),
  '070426001': Object.freeze({
    ...
    events: Object.freeze([
      Object.freeze({ label: '共同展示交流', date: '2026-12-26' }),
    ]),
    deliveryNote: '官方 115-1 課綱：可接受非同步授課；同步遠距為週四 13:10–16:00。',
  }),
  '070427001': Object.freeze({
    correctionId: 'nccu-1151-taica-070427001',
    deliveryMode: 'asynchronous-optional',
    meetings: Object.freeze([
      Object.freeze({ day: 4, start: 540, end: 720, label: '週四 09:00–12:00' }),
    ]),
    events: Object.freeze([
      Object.freeze({ label: '實體考試', date: '2026-12-10', day: 4, start: 540, end: 720 }),
    ]),
    deliveryNote: '官方 115-1 課綱：可接受非同步授課；同步遠距為週四 09:00–12:00。',
  }),
  '070455001': Object.freeze({
    ...
    events: Object.freeze([
      Object.freeze({ label: '實體同步考試，時間待確認', date: '2026-12-09' }),
    ]),
    deliveryNote: '官方 115-1 課綱：可接受非同步授課；同步遠距為週三 09:10–12:10。',
  }),
});
...
export function applyVerifiedScheduleCorrections(candidate) {
  ...
  return {
    ...
    informationNotes: [...new Set([
      ...(candidate.informationNotes || []),
      ...(correction.informationNotes || []),
    ])],
